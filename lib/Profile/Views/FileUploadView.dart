...
import 'package:http_parser/http_parser.dart'; // For specifying the file type
...
class FileUploadView extends StatefulWidget {
  ...
  FileUploadView({required this.title,required this.height,required this.width,required this.universityName,required this.courseName});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  _filePath != ""? Text(_filePath != ""? " Subimted":"",
