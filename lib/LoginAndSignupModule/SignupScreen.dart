        ...
        child: Padding(
          ...
          child: Column(
            children: [
                          ...
                          builder: (context, up, _) => Padding(
                            ...
                            child: CustomDropdownNew<Country>(
                              ...
                              onChanged: (value) {
                                if (value != null) {
                                  debugPrint(
                                      'value.countryID ${value.name}: ${value.countryID.toString()}');
                                  setState(() {
                                    _city = null;
                                    _country = value;
              ...
              Consumer<UserProvider>(
                builder: (context, up, _) => up.signupLoadingButton
                          ...
                          onPressed: () async {
                            ...
                            if (validateFields()) {
                              ...
                              bool result = await up.signUp(
                                  ...
                                  mobile:
                                      initialCountry + phoneNoController.text,
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            Navigator.pushReplacement(
                                                ...
                                                CupertinoPageRoute(
                                                    builder: (context) =>
                                                        LoginBottomSheet())); // Close the dialog
                                          },
                                          child: const Text('OK',
