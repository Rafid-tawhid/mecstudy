...
import 'Views/ParagraphView.dart';
import 'Views/RatingView.dart';
import 'Views/TabbarView.dart';
...
class CourseDetailScreen extends StatefulWidget {
  ...
  List<Alumnus> alumus;
  List<Faq> faqs;
  CourseDetailScreen({required this.universityDetialModel,required this.rankings,required this.facilties,required this.alumus,required this.faqs,required this.courseModel});
  @override
...
class QAExpansionTile extends StatelessWidget {
  ...
  QAExpansionTile({required this.question, required this.answer});
